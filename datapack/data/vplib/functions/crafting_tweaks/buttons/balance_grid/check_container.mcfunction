...
execute if score #grid_changed vplib.temp matches 0 if score #result_changed vplib.temp matches 0 run function vplib:crafting_tweaks/buttons/balance_grid/main